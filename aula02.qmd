...
Inicialmente, deve-se entender que $( (A\cap B)=(B\cap A) )$. Após, aplica-se a definição 12 de probabilidade condicional dada por $P(E_1 | E_2 )= P(E_1\cap E_2 )/(P( E_2))$.
...
Usando a definição de probabilidade condicional $( P({A_j\cap B})=P(B|A_j )\times P(A_j) )$ podemos reescrever $P(B)$:
